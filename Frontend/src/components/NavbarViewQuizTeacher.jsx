...
function NavbarViewQuizTeacher() {
      ...
      <div className="bg-blue-500">
        <nav className="flex justify-between items-center px-4 py-4 bg-white">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to="/dashboard"
              className="hidden lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-full transition duration-200"
            >
              Home
            </Link>
            <a
...
export default NavbarViewQuizTeacher;
